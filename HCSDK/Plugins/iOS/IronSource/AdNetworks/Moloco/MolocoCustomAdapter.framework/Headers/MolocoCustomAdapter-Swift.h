...
#ifndef MOLOCOCUSTOMADAPTER_SWIFT_H
#define MOLOCOCUSTOMADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MolocoCustomAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// From MolocoAdapter you can get different helpful tools.
SWIFT_CLASS("_TtC19MolocoCustomAdapter13MolocoAdapter")
@interface MolocoAdapter : NSObject
/// Version of MolocoAdapter tools
///
/// returns:
/// string version in x.x.x.x format
...
SWIFT_CLASS("_TtC19MolocoCustomAdapter21MolocoPrivacySettings")
